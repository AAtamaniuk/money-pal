...
const getCostCategoriesOnly = array => R.filter(i => i !== 'income', getCategoriesList(array));
const getTotal = array => R.sum(R.map(getValues, array));

const filterByCategory = (array, category) => R.filter(i => i.category === category, array);
const getSumByCategory = (array, category) => getTotal(filterByCategory(array, category));

const getIcomeSum = array => getTotal(R.filter(i => i.category === 'income', array));
const getCostsSum = array => getTotal(R.filter(i => i.category !== 'income', array));
